...
def parse_args():
    ...
    parser.add_argument('--model_save_dir', type=str, default='D:\ProjectFiles\exp_202603\\results/models',
                        help='path to save results.')
    parser.add_argument('--res_save_dir', type=str, default='D:\ProjectFiles\exp_202603\\results/results',
                        help='path to save results.')
...
if __name__ == '__main__':
    ...
    # 根据模型类型设置默认的预训练模型路径
    if args.pretrain_LM == 'D:\ProjectFiles\exp_202603\models/chatglm3-6b-base/':
        if args.model_type == 'qwen':
            args.pretrain_LM = 'D:\ProjectFiles\exp_202603\models/Qwen/Qwen-1_8B/'
        elif args.model_type == 'qwen3.5':
            args.pretrain_LM = 'D:\ProjectFiles\exp_202603\models/Qwen/Qwen-3_5B/'
        elif args.model_type == 'llama2':
            args.pretrain_LM = 'D:\ProjectFiles\exp_202603\models/Meta/Llama-2-7b-hf/'
        elif args.model_type == 'deepseek':
            args.pretrain_LM = 'D:\ProjectFiles\exp_202603\models/deepseek-ai/deepseek-llm-7b-base/'
